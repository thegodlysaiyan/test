...
function (_React$Component) {
  ...
  function InfiniteList(props) {
    ...
    _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(InfiniteList).call(this, props));
    _this.update = _this.update.bind((0, _assertThisInitialized2.default)(_this));
    _this.enableListeners = _this.enableListeners.bind((0, _assertThisInitialized2.default)(_this));
    _this.disableListeners = _this.disableListeners.bind((0, _assertThisInitialized2.default)(_this));
  ...
  (0, _createClass2.default)(InfiniteList, [{
    ...
    value: function enableListeners() {
      ...
      this.resizeObserver = new _resizeObserverPolyfill.default(function (entries) {
        _this3.handleResize(entries[0].contentRect);
      });
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          customProps = (0, _objectWithoutProperties2.default)(_this$props, ["ariaLabel", "children", "dividerStyle", "initialLoadingIndicator", "intl", "isFinishedLoading", "onRequestItems", "paddingStyle", "progressiveLoadingIndicator", "progressiveLoadingMessage", "role", "refCallback"]);
      ...
      if (!isFinishedLoading) {
        if (this.childCount > 0) {
          loadingSpinner = _react.default.createElement("div", {
            className: cx('spacer'),
            key: "infinite-spinner-row-".concat(this.loadingIndex)
          }, progressiveLoadingIndicator);
        } else {
          /* eslint-disable react/forbid-dom-props */
          initialSpinner = _react.default.createElement("div", {
            className: cx('spacer'),
      ...
      if (!initialSpinner) {
        ...
        if (!this.scrollGroups.length && this.lastChildIndex <= 0 || !this.renderNewChildren) {
          ...
          newChildren = _react.default.createElement(_terraList.default, (0, _extends2.default)({}, attrSpread, {
      ...
      return _react.default.createElement(_react.default.Fragment, null, _react.default.createElement("div", (0, _extends2.default)({}, customProps, {
        className: cx(['infinite-list', customProps.className]),
        ref: this.setContentNode
      }), initialSpinner, topSpacer, _react.default.createElement(_terraList.default, (0, _extends2.default)({}, attrSpread, {
        "aria-label": ariaLabel,
        refCallback: refCallback
      }), visibleChildren), bottomSpacer, loadingSpinner), newChildren, _react.default.createElement(_terraVisuallyHiddenText.default, {
        "aria-atomic": "true",
        "aria-live": "assertive",
