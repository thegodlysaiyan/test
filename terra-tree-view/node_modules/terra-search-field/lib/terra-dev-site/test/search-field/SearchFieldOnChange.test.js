...
var SearchFieldOnChange = /*#__PURE__*/function (_React$Component) {
  ...
  function SearchFieldOnChange(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(SearchFieldOnChange).call(this, props));
  ...
  _createClass(SearchFieldOnChange, [{
    ...
    value: function render() {
      ...
      }, this.state.callCount), _react.default.createElement("p", {
        id: "searchOnChangeText"
      }, this.state.searchText), _react.default.createElement(_SearchField.default, {
        id: "searchfield",
...
var _default = SearchFieldOnChange;
