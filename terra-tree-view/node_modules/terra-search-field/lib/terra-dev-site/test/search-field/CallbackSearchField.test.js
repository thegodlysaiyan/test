...
var CallbackSearchField = /*#__PURE__*/function (_React$Component) {
  ...
  function CallbackSearchField(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(CallbackSearchField).call(this, props));
    _this.state = {
      searchText: '',
      message: ''
    };
...
var _default = CallbackSearchField;
