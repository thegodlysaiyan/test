...
var MinimumLengthSearchField = /*#__PURE__*/function (_React$Component) {
  ...
  function MinimumLengthSearchField(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(MinimumLengthSearchField).call(this, props));
    _this.state = {
      searchText: ''
    };
    return _this;
  ...
  _createClass(MinimumLengthSearchField, [{
    ...
    value: function render() {
      ...
      }, "Search Text:", ' ', this.state.searchText), _react.default.createElement(_SearchField.default, {
...
var _default = MinimumLengthSearchField;
