...
var DelayedSearchField = /*#__PURE__*/function (_React$Component) {
  ...
  function DelayedSearchField(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(DelayedSearchField).call(this, props));
    _this.state = {
      searchText: ''
    };
    return _this;
...
var _default = DelayedSearchField;
