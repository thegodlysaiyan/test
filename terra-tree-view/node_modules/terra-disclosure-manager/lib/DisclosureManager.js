  ...
  (0, _createClass2.default)(DisclosureManager, [{
      ...
      return {
        register: function register(_ref) {
          ...
          _this2.setState(function (state) {
            return {
              disclosureComponentData: _objectSpread({}, state.disclosureComponentData, {}, (0, _defineProperty2.default)({}, key, _objectSpread({}, state.disclosureComponentData[key], {
                headerAdapterData: {
    ...
    value: function generateDisclosureComponentMappingForRender(withDisclosureContainer) {
      ...
      return disclosureComponentKeys.reduce(function (accumulator, key, index) {
        ...
        accumulator[key] = {
          component: _react.default.createElement(_DisclosureManagerHeaderAdapterContext.default.Provider, {
            value: componentData.headerAdapterContextValue,
            key: key
          }, _react.default.createElement(_DisclosureManagerContext.default.Provider, {
