...
var SlideGroupDemo = /*#__PURE__*/function (_React$Component) {
  ...
  function SlideGroupDemo(props) {
    ...
    _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(SlideGroupDemo).call(this, props));
    ...
    value: function render() {
      ...
      for (var i = 0; i < this.state.counter; i += 1) {
        slides.push(_react.default.createElement("div", {
          key: "Slide ".concat(i),
          className: cx('slide')
        }, _react.default.createElement("h2", null, "Slide", i), _react.default.createElement("br", null), _react.default.createElement("button", {
          type: "button",
          onClick: this.increment
        }, "Increment"), i !== 0 ? _react.default.createElement("button", {
          type: "button",
