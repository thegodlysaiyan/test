...
var _SlideGroup = _interopRequireDefault(require("../../../SlideGroup"));

var _SlideGroupDemoModule = _interopRequireDefault(require("../../doc/example/SlideGroupDemo.module.scss"));
...
var SlideGroupExample = /*#__PURE__*/function (_React$Component) {
  ...
  function SlideGroupExample(props) {
    ...
    _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(SlideGroupExample).call(this, props));
    _this.state = {
      counter: 1
    };
  ...
  (0, _createClass2.default)(SlideGroupExample, [{
    ...
    value: function render() {
      ...
      for (var i = 1; i <= this.state.counter; i += 1) {
        slides.push(_react.default.createElement("div", {
          key: i
        }, _react.default.createElement("h2", null, "Slide", ' ', i), _react.default.createElement("br", null), i !== 4 ? _react.default.createElement("button", {
          type: "button",
          id: "increment-".concat(i),
          className: cx('button'),
          onClick: this.increment
        }, "Increment") : null, i !== 1 ? _react.default.createElement("button", {
          type: "button",
      ...
      }, _react.default.createElement(_SlideGroup.default, {
        items: slides,
        id: "SlideGroup"
      }));
    }
