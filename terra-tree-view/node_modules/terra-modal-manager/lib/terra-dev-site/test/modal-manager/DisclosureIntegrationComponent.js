...
var DisclosureComponent = /*#__PURE__*/function (_React$Component) {
  ...
  (0, _createClass2.default)(DisclosureComponent, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement(_terraContentContainer.default, {
      ...
      }, this.renderForm(), this.renderFormButton(), _react.default.createElement("br", null), _react.default.createElement("br", null), _react.default.createElement(_terraFormSelect.default, {
        label: "T-shirt size",
        placeholder: "Select a size",
        selectId: "tshirt-size-field",
        required: true,
        className: cx('select-field')
      }, _react.default.createElement(_terraFormSelect.default.Option, {
        value: "Red",
        display: "Red"
      }), _react.default.createElement(_terraFormSelect.default.Option, {
        value: "Orange",
        ...
        value: "Pink",
        display: "Pink"
      }))), disclosureManager && disclosureManager.dismiss ? _react.default.createElement("button", {
        type: "button",
        className: "dismiss",
