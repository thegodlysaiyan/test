...
var _ArrowSmallTargetLeftPopupTestModule = _interopRequireDefault(require("./ArrowSmallTargetLeftPopup.test.module.scss"));

var cx = _bind.default.bind(_ArrowSmallTargetLeftPopupTestModule.default); // This tests verifies the PopupUtils.getContentOffset methed when (targetNode.clientWidth < segment) & attachment is left


var OffsetPopup = /*#__PURE__*/function (_React$Component) {
  (0, _inherits2.default)(OffsetPopup, _React$Component);

  function OffsetPopup(props) {
    var _this;

    (0, _classCallCheck2.default)(this, OffsetPopup);
    _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(OffsetPopup).call(this, props));
  ...
  (0, _createClass2.default)(OffsetPopup, [{
    ...
    value: function render() {
      ...
      }, "This popup was adjusted because the target was smaller than the arrow position allowed.")), _react.default.createElement("button", {
        type: "button",
        id: "offset-button",
