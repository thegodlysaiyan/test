...
var _BoundedNoHeaderContent = _interopRequireDefault(require("../common/BoundedNoHeaderContent"));

var _BoundedPopupCommonTestModule = _interopRequireDefault(require("./BoundedPopupCommon.test.module.scss"));

var cx = _bind.default.bind(_BoundedPopupCommonTestModule.default);
...
var BoundedPopup = /*#__PURE__*/function (_React$Component) {
  ...
  function BoundedPopup(props) {
    ...
    _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(BoundedPopup).call(this, props));
  ...
  (0, _createClass2.default)(BoundedPopup, [{
    ...
    value: function render() {
      ...
      }, _react.default.createElement(_BoundedNoHeaderContent.default, null)), _react.default.createElement("button", {
        type: "button",
        id: "bounded-button",
