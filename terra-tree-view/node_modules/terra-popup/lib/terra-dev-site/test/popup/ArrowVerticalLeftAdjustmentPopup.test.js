...
var _ArrowVerticalLeftAdjustmentPopupTestModule = _interopRequireDefault(require("./ArrowVerticalLeftAdjustmentPopup.test.module.scss"));

var cx = _bind.default.bind(_ArrowVerticalLeftAdjustmentPopupTestModule.default); // This tests verifies the PopupUtils.leftOffset methed when (offset < (2 * arrowOffset) + cornerOffset)
...
var AlignmentPopup = /*#__PURE__*/function (_React$Component) {
  ...
  (0, _createClass2.default)(AlignmentPopup, [{
    ...
    value: function render() {
      ...
      }, "This popup arrow has verital-left attachment, but was adjusted to be on the screen.")), _react.default.createElement("button", {
        type: "button",
        id: "alignment-button",
