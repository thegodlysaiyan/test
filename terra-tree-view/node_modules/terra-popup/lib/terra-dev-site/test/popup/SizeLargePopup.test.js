...
var _SizeLargePopupTestModule = _interopRequireDefault(require("./SizeLargePopup.test.module.scss"));

var cx = _bind.default.bind(_SizeLargePopupTestModule.default);
...
var DimensionPopup = /*#__PURE__*/function (_React$Component) {
  ...
  function DimensionPopup(props) {
    ...
    _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(DimensionPopup).call(this, props));
  ...
  (0, _createClass2.default)(DimensionPopup, [{
    ...
    value: function render() {
      ...
      }, _react.default.createElement("p", null, "This popup is 240h by 960w.")), _react.default.createElement("button", {
        type: "button",
        id: "dimension-button",
