...
var _ArrowVerticalAttachmentsPopupTestModule = _interopRequireDefault(require("./ArrowVerticalAttachmentsPopup.test.module.scss"));

var cx = _bind.default.bind(_ArrowVerticalAttachmentsPopupTestModule.default);
...
var AlignmentPopup = /*#__PURE__*/function (_React$Component) {
  ...
  (0, _createClass2.default)(AlignmentPopup, [{
    ...
    value: function render() {
      ...
      }, "This popup arrow has vertical attachment.")), _react.default.createElement("button", {
        type: "button",
        id: "alignment-button",
        className: cx('popup-button'),
        onClick: this.handleButtonClick,
        ref: this.setButtonNode
      }, '')), _react.default.createElement("p", null, "Choose Content Attachment:"), _react.default.createElement("button", {
        type: "button",
        id: "attach-Left",
        value: "bottom left",
        onClick: this.handleAttachment
      }, "Attach Bottom Left"), _react.default.createElement("button", {
        type: "button",
        id: "attach-Center",
        value: "bottom center",
        onClick: this.handleAttachment
      }, "Attach Bottom Center"), _react.default.createElement("button", {
        type: "button",
        id: "attach-Right",
        value: "bottom right",
        onClick: this.handleAttachment
