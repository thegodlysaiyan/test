...
var _AutomaticWidthBoundedPopupTestModule = _interopRequireDefault(require("./AutomaticWidthBoundedPopup.test.module.scss"));

var cx = _bind.default.bind(_AutomaticWidthBoundedPopupTestModule.default);
...
var PopupExample = /*#__PURE__*/function (_React$Component) {
  ...
  function PopupExample(props) {
    ...
    _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(PopupExample).call(this, props));
  ...
  (0, _createClass2.default)(PopupExample, [{
    ...
    value: function render() {
      ...
      }, "This is popup content with a automatic width of 400px, but is bounded by the parent width of 200px.")), _react.default.createElement("button", {
        type: "button",
        id: "default-button",
