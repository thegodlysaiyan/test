...
var _ArrowHorizontalAttachmentsPopupTestModule = _interopRequireDefault(require("./ArrowHorizontalAttachmentsPopup.test.module.scss"));

var cx = _bind.default.bind(_ArrowHorizontalAttachmentsPopupTestModule.default);
...
var AlignmentPopup = /*#__PURE__*/function (_React$Component) {
  ...
  function AlignmentPopup(props) {
    ...
    _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(AlignmentPopup).call(this, props));
  ...
  (0, _createClass2.default)(AlignmentPopup, [{
    ...
    value: function render() {
      ...
      }, "This popup arrow was horizontally attached.")), _react.default.createElement("button", {
        type: "button",
        id: "alignment-button",
        className: cx('popup-button'),
        onClick: this.handleButtonClick,
        ref: this.setButtonNode
      }, '')), _react.default.createElement("p", null, "Choose Target Attachment:"), _react.default.createElement("button", {
        type: "button",
        id: "attach-Top",
        value: "top right",
        onClick: this.handleAttachment
      }, "Attach Top Right"), _react.default.createElement("button", {
        type: "button",
        id: "attach-Middle",
        value: "middle right",
        onClick: this.handleAttachment
      }, "Attach Middle Right"), _react.default.createElement("button", {
        type: "button",
        id: "attach-Bottom",
        value: "bottom right",
        onClick: this.handleAttachment
