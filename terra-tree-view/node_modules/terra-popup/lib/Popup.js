...
var Popup = /*#__PURE__*/function (_React$Component) {
  ...
  (0, _createClass2.default)(Popup, [{
    ...
    value: function createPopupContent(boundingFrame, showArrow) {
      ...
      if (showArrow) {
        arrow = _react.default.createElement(_PopupArrow.default, {
          className: this.props.classNameArrow,
          refCallback: this.setArrowNode
        });
      }

      return _react.default.createElement(_PopupContent.default, (0, _extends2.default)({}, boundsProps, {
        arrow: arrow,
    ...
    value: function render() {
      ...
      return _react.default.createElement(_react.default.Fragment, null, _react.default.createElement(_reactPortal.Portal, {
        isOpened: isOpen
      }, _react.default.createElement(_PopupOverlay.default, {
        className: this.props.classNameOverlay,
        onRequestClose: this.props.onRequestClose
      })), _react.default.createElement(_terraHookshot.default, {
