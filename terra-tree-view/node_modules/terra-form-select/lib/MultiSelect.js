...
var MultiSelect = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(MultiSelect, [{
    ...
    value: function display() {
      ...
      return selectValue.map(function (tag) {
        return _react.default.createElement(_Tag.default, {
          value: tag,
          key: tag,
          onDeselect: _this2.handleDeselect
        }, _SelectUtil.default.valueDisplay(_this2.props, tag));
      });
    }
    /**
    ...
    value: function handleSelect(value, option) {
      var newValue = [].concat(_toConsumableArray(_SelectUtil.default.value(this.props, this.state)), [value]);
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          otherProps = _objectWithoutProperties(_this$props, ["children", "defaultValue", "onChange", "placeholder", "required", "value", "intl", "inputId"]);
...
MultiSelect.Option = _Option.default;
MultiSelect.OptGroup = _OptGroup.default;
MultiSelect.propTypes = propTypes;
MultiSelect.defaultProps = defaultProps;
MultiSelect.isSelect = true;

var _default = (0, _reactIntl.injectIntl)(MultiSelect);
