...
var SingleSelectField = function SingleSelectField(_ref) {
  var allowClear = _ref.allowClear,
      ...
      value = _ref.value,
      customProps = _objectWithoutProperties(_ref, ["allowClear", "children", "defaultValue", "disabled", "error", "help", "hideRequired", "isIncomplete", "isInline", "isInvalid", "isLabelHidden", "label", "labelAttrs", "maxWidth", "onChange", "placeholder", "required", "selectAttrs", "selectId", "showOptional", "value"]);
  ...
  return _react.default.createElement(_terraFormField.default, _extends({}, customProps, {
    ...
    htmlFor: selectId,
    maxWidth: maxWidth
  }), _react.default.createElement(_SingleSelect.default, _extends({}, selectAttrs, {
    ariaLabel: label,
...
SingleSelectField.Option = _Option.default;
SingleSelectField.OptGroup = _OptGroup.default;
