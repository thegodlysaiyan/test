  ...
  _createClass(Frame, [{
    ...
    value: function render() {
      ...
      var _this$props6 = this.props,
          ...
          customProps = _objectWithoutProperties(_this$props6, ["ariaLabel", "clearOptionDisplay", "children", "disabled", "display", "dropdownAttrs", "intl", "inputId", "isIncomplete", "isTouchAccessible", "isInvalid", "maxHeight", "noResultContent", "onDeselect", "onSearch", "onSelect", "optionFilter", "placeholder", "required", "totalOptions", "value"]);

      var selectClasses = cx(['select', 'search', {
