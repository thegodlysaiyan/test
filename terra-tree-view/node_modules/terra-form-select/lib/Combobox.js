...
var _Frame = _interopRequireDefault(require("./combobox/Frame"));
...
var Combobox = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(Combobox, [{
    ...
    value: function handleSelect(value, option) {
      this.handleChange(_SelectUtil.default.select(this.props, this.state, value)); // Add new tags for uncontrolled components.

      if (this.props.value === undefined && !_SelectUtil.default.findByValue(this.props, this.state, value)) {
        this.setState(function (prevState) {
          return {
            tags: [].concat(_toConsumableArray(prevState.tags), [_react.default.createElement(_Option.default, {
              key: value,
              display: value,
              value: value
            })])
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          otherProps = _objectWithoutProperties(_this$props, ["allowClear", "children", "defaultValue", "onChange", "placeholder", "required", "value", "intl", "inputId"]);
...
Combobox.Option = _Option.default;
Combobox.OptGroup = _OptGroup.default;
Combobox.propTypes = propTypes;
Combobox.defaultProps = defaultProps;
Combobox.isSelect = true;

var _default = (0, _reactIntl.injectIntl)(Combobox);
