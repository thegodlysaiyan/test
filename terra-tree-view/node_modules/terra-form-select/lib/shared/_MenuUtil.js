...
var MenuUtil = /*#__PURE__*/function () {
  ...
  _createClass(MenuUtil, null, [{
    ...
    value: function filter(object, searchValue, optionFilter) {
      return _react.default.Children.toArray(object).reduce(function (accumulator, option) {
        if (option.type.isOption && MenuUtil.filterOption(option, searchValue, optionFilter)) {
          ...
          var children = MenuUtil.filter(option.props.children, searchValue, optionFilter); // Ignore groups that do not contain any filtered options.

          if (children.length > 0) {
            accumulator.push(_react.default.cloneElement(option, {}, children));
          }
        }
    ...
    value: function updateSelectionState(object, props) {
      ...
      return _react.default.Children.map(object, function (child) {
        ...
        if (child.type.isOptGroup) {
          return _react.default.cloneElement(child, {}, MenuUtil.updateSelectionState(child.props.children, props));
        }
    ...
    value: function shouldShowClearOption(_ref5) {
      var clearOptionDisplay = _ref5.clearOptionDisplay,
          searchValue = _ref5.searchValue,
          hasAddOption = _ref5.hasAddOption,
          hasNoResults = _ref5.hasNoResults;
