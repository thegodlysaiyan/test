...
var Option = function Option(_ref) {
  var disabled = _ref.disabled,
      ...
      customProps = _objectWithoutProperties(_ref, ["disabled", "display", "value", "variant", "isActive", "isSelected", "isCheckable", "isAddOption"]);

  var optionClassNames = cx(['option', {
    'is-active': isActive
  }, {
  ...
  }), (isCheckable || isAddOption) && _react.default.createElement("span", {
    className: cx('icon')
