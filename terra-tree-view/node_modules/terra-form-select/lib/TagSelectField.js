...
var TagSelectField = function TagSelectField(_ref) {
  var children = _ref.children,
      ...
      value = _ref.value,
      customProps = _objectWithoutProperties(_ref, ["children", "defaultValue", "disabled", "error", "help", "hideRequired", "intl", "isIncomplete", "isInline", "isInvalid", "isLabelHidden", "isTouchAccessible", "label", "labelAttrs", "maxSelectionCount", "maxWidth", "onChange", "placeholder", "required", "selectAttrs", "selectId", "showOptional", "value"]);
  ...
  return _react.default.createElement(_terraFormField.default, _extends({}, customProps, {
    ...
    htmlFor: selectId,
    maxWidth: maxWidth
  }), _react.default.createElement(_TagSelect.default, _extends({}, selectAttrs, {
    ariaLabel: label,
...
TagSelectField.Option = _Option.default;
TagSelectField.OptGroup = _OptGroup.default;

var _default = (0, _reactIntl.injectIntl)(TagSelectField);
