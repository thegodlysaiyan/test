...
var MultiSelectField = function MultiSelectField(_ref) {
  ...
  return _react.default.createElement(_terraFormField.default, _extends({}, customProps, {
    ...
    htmlFor: selectId,
    maxWidth: maxWidth
  }), _react.default.createElement(_MultiSelect.default, _extends({}, selectAttrs, {
    ariaLabel: label,
...
MultiSelectField.Option = _Option.default;
MultiSelectField.OptGroup = _OptGroup.default;

var _default = (0, _reactIntl.injectIntl)(MultiSelectField);
