...
var _AddOption = _interopRequireDefault(require("../shared/_AddOption"));
...
var Menu = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(Menu, null, [{
    ...
    value: function shouldAllowFreeText(props, children) {
      ...
      var option = _MenuUtil.default.findByDisplay(children, searchValue);

      var included = _MenuUtil.default.isEqual(value, searchValue);
    ...
    value: function updateSelectionState(object, props) {
      ...
      return _react.default.Children.map(object, function (child) {
        ...
        if (child.type.isOptGroup) {
          return _react.default.cloneElement(child, {}, Menu.updateSelectionState(child.props.children, props));
        }
  ...
  _createClass(Menu, [{
    ...
    value: function updateNoResultsScreenReader() {
      ...
      this.liveRegionTimeOut = setTimeout(function () {
        var hasMaxSelection = _this2.state.hasMaxSelection;
        var _this2$props = _this2.props,
            intl = _this2$props.intl,
            visuallyHiddenComponent = _this2$props.visuallyHiddenComponent; // Race condition can occur between calling timeout and unmounting this component.
    ...
    value: function updateCurrentActiveScreenReader() {
      ...
      if (active && active.hasAttribute('data-terra-select-add-option')) {
        var display = active.querySelector("[class*='display']").innerText;
    ...
    value: function handleKeyDown(event) {
      ...
      if (keyCode === KeyCode.KEY_UP) {
        ...
        var option = _MenuUtil.default.findByValue(children, active); // Handles communicating the case where a regular option is selected to screen readers.
        ...
        var _option = _MenuUtil.default.findByValue(children, active); // Handles communicating the case where a regular option is Unselected to screen readers.
    ...
    value: function getDerivedStateFromProps(props, state) {
      ...
      if (searchValue && searchValue.length > 0 && Menu.isMaxSelectionReached(props)) {
        children = [_react.default.createElement(_MaxSelection.default, {
        ...
        if (Menu.shouldAllowFreeText(props, children)) {
          children.push(_react.default.createElement(_AddOption.default, {
            value: searchValue
          }));
        }
      }
