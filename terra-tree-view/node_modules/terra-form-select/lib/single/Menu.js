  ...
  _createClass(Menu, null, [{
    ...
    value: function getActiveOptionFromProps(props, children, state) {
      ...
      var selected = options.find(function (option) {
        return _MenuUtil.default.isEqual(value, option.props.value);
      });
  ...
  _createClass(Menu, [{
    ...
    value: function updateNoResultsScreenReader() {
      ...
      this.liveRegionTimeOut = setTimeout(function () {
        var hasNoResults = _this3.state.hasNoResults;
        var _this3$props = _this3.props,
            intl = _this3$props.intl,
            visuallyHiddenComponent = _this3$props.visuallyHiddenComponent; // Race condition can occur between calling timeout and unmounting this component.
      ...
      return _react.default.Children.map(object, function (option) {
        if (option.type.isOption) {
          return _react.default.cloneElement(option, _objectSpread({
            ...
            isActive: option.props.value === _this4.state.active,
            isCheckable: false,
            isSelected: _MenuUtil.default.isSelected(_this4.props.value, option.props.value),
            variant: 'default',
            onMouseDown: function onMouseDown() {
              _this4.downOption = option;
            },
            onMouseUp: function onMouseUp(event) {
              return _this4.handleOptionClick(event, option);
            },
            onMouseEnter: function onMouseEnter(event) {
              return _this4.handleMouseEnter(event, option);
            }
          }, option.props.value === _this4.state.active && {
            'data-select-active': true
          }));
        }

        if (option.type.isOptGroup) {
          return _react.default.cloneElement(option, {}, _this4.clone(option.props.children));
        }
      ...
      if (keyCode === KeyCode.KEY_UP) {
        ...
        if (this.props.clearOptionDisplay) {
          ...
          */
          ...
          if (!_SharedUtil.default.isSafari()) {
            visuallyHiddenComponent.current.innerText = "".concat(option.props.display, " ").concat(selectedTxt);
          }
        }
        ...
        this.setState(function (prevState) {
          return {
            active: _MenuUtil.default.findWithStartString(prevState.children, _this5.searchString) || active
          };
        });
      }
    }
    ...
    value: function getDerivedStateFromProps(props, state) {
      ...
      var children = _MenuUtil.default.filter(props.children, '');

      children = _MenuUtil.default.updateSelectionState(children, props);

      if (_MenuUtil.default.shouldShowNoResults(props, children)) {
