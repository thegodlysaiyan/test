...
var Frame = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(Frame, [{
    ...
    key: "getDisplay",
    value: function getDisplay(ariaDescribedBy) {
    ...
    value: function render() {
      ...
      var _this$props6 = this.props,
          ...
          clearOptionDisplay = _this$props6.clearOptionDisplay,
          children = _this$props6.children,
          disabled = _this$props6.disabled,
          display = _this$props6.display,
          dropdownAttrs = _this$props6.dropdownAttrs,
          inputId = _this$props6.inputId,
          intl = _this$props6.intl,
          isIncomplete = _this$props6.isIncomplete,
          isTouchAccessible = _this$props6.isTouchAccessible,
          isInvalid = _this$props6.isInvalid,
          maxHeight = _this$props6.maxHeight,
          noResultContent = _this$props6.noResultContent,
          onDeselect = _this$props6.onDeselect,
          onSearch = _this$props6.onSearch,
          onSelect = _this$props6.onSelect,
          optionFilter = _this$props6.optionFilter,
          placeholder = _this$props6.placeholder,
          required = _this$props6.required,
          totalOptions = _this$props6.totalOptions,
          value = _this$props6.value,
          customProps = _objectWithoutProperties(_this$props6, ["ariaLabel", "clearOptionDisplay", "children", "disabled", "display", "dropdownAttrs", "inputId", "intl", "isIncomplete", "isTouchAccessible", "isInvalid", "maxHeight", "noResultContent", "onDeselect", "onSearch", "onSelect", "optionFilter", "placeholder", "required", "totalOptions", "value"]);

      var selectClasses = cx(['select', 'combobox', {
      ...
      }, this.getDisplay(ariaDescribedBy)), this.renderToggleButton(), _react.default.createElement("span", {
        "aria-atomic": "true",
        "aria-live": "assertive",
