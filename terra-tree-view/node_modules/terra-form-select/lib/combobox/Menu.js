  ...
  _createClass(Menu, [{
    ...
    value: function updateCurrentActiveScreenReader() {
      ...
      if (clearOptionDisplay) {
        var _active = this.menu.querySelector('[data-select-active]');

        if (_active && _active.hasAttribute('data-terra-select-clear-option')) {
    ...
    value: function getDerivedStateFromProps(props, state) {
      ...
      var children = _MenuUtil.default.filter(props.children, props.searchValue, props.optionFilter);
