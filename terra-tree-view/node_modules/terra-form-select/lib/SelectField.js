...
var propTypes = {
   ...
   */
  defaultValue: _propTypes.default.oneOfType([_propTypes.default.array, _propTypes.default.number, _propTypes.default.string]),
...
var SelectField = function SelectField(_ref) {
  var allowClear = _ref.allowClear,
      ...
      maxSelectionCount = _ref.maxSelectionCount,
      ...
      customProps = _objectWithoutProperties(_ref, ["allowClear", "children", "defaultValue", "disabled", "error", "help", "hideRequired", "intl", "isIncomplete", "isInline", "isInvalid", "isLabelHidden", "isTouchAccessible", "label", "labelAttrs", "maxSelectionCount", "maxWidth", "onChange", "placeholder", "required", "selectAttrs", "selectId", "showOptional", "value", "variant"]);

  var helpText = help;

  if (maxSelectionCount !== undefined && maxSelectionCount >= 2) {
    var limitSelectionText = intl.formatMessage({
      id: 'Terra.form.select.maxSelectionHelp'
    }, {
      text: maxSelectionCount
    });

    if (help) {
      helpText = _react.default.createElement("span", null, limitSelectionText, ' ', help);
    } else {
  ...
  return _react.default.createElement(_terraFormField.default, _extends({}, customProps, {
    ...
    htmlFor: selectId,
    maxWidth: maxWidth
  }), _react.default.createElement(_Select.default, _extends({}, selectAttrs, {
    ariaLabel: label,
...
SelectField.Option = _Select.default.Option;
SelectField.OptGroup = _Select.default.OptGroup;

var _default = (0, _reactIntl.injectIntl)(SelectField);
