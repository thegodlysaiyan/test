...
window.sessionStorage.redirect = window.location.href; // Redirect to the base path. Once done react router will use the stored location to route SPA style.

window.location.pathname = "".concat(TERRA_DEV_SITE_BASENAME, "/");