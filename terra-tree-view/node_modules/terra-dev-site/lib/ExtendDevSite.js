...
var _siteConfig = _interopRequireDefault(require("build/terra-application/siteConfig"));
...
var ExtendDevSite = function ExtendDevSite() {
    ...
    applicationNavigation: function applicationNavigation(_ref3) {
      ...
      return _react.default.createElement(_applicationNavigation.default, {
        ...
        header: _react.default.createElement("h1", {
          className: "terra-dev-site-extended"
        }, "Terra Dev Site Extended Example"),
        fill: true
      }, child));
    },
...
_reactDom.default.render(_react.default.createElement(ExtendDevSite, null), document.getElementById('root'));