...
var LoadingOverlay = function LoadingOverlay(_ref) {
  var isAnimated = _ref.isAnimated,
      ...
      customProps = _objectWithoutProperties(_ref, ["isAnimated", "message", "rootSelector"]);

  // eslint-disable-next-line no-param-reassign
  delete customProps.onRequestClose;
  return _react.default.createElement(_Overlay.default, _extends({}, customProps, {
    className: cx('loading-overlay', customProps.className),
    rootSelector: rootSelector,
    "aria-live": "polite"
  }), _react.default.createElement(_IconSpinner.default, {
    className: cx('icon'),
    isSpin: isAnimated,
    height: "36",
    width: "36"
  }), message !== undefined ? _react.default.createElement("div", {
