...
var _OverlayDocCommonModule = _interopRequireDefault(require("./OverlayDocCommon.module.scss"));
...
var cx = _bind.default.bind(_OverlayDocCommonModule.default);
...
var OverlayExample = /*#__PURE__*/function (_React$Component) {
  ...
  function OverlayExample() {
    ...
    _this.handleOnRequestESC = _this.handleOnRequestESC.bind(_assertThisInitialized(_this));
    return _this;
  }
  ...
  _createClass(OverlayExample, [{
    ...
    value: function addOverlay() {
      return _react.default.createElement(_terraOverlay.default, {
        isOpen: this.state.show,
        isRelativeToContainer: this.state.relative,
        onRequestClose: this.handleOnRequestESC,
        zIndex: "6000"
      }, _react.default.createElement("p", null, "Close by clicking the overlay or pressing the ESC key."));
    }
  }, {
    key: "render",
    value: function render() {
      return _react.default.createElement(_OverlayContainer.default, {
        className: cx('overlay-container'),
        overlay: this.addOverlay()
      }, _react.default.createElement(_terraButton.default, {
        text: "Trigger Container Overlay",
        onClick: this.handleTriggerOverlay
      }), _react.default.createElement(_terraButton.default, {
        text: "Trigger FullScreen Overlay",
