...
var PopupMenuListItem = function PopupMenuListItem(_ref) {
  var icon = _ref.icon,
      ...
      customProps = (0, _objectWithoutProperties2.default)(_ref, ["icon", "text", "notificationCount", "onSelect", "showSelections", "isSelected", "loopFocus", "parentRole"]);
  ...
  return _react.default.createElement("li", (0, _extends2.default)({}, ariaSpread, customProps, {
    tabIndex: "0",
    className: cx('item'),
    onClick: onSelect,
    ...
    ref: itemRef
  }), showSelections ? _react.default.createElement("div", {
    className: cx('selection-icon')
  }, isSelected ? _react.default.createElement(_IconCheckmark.default, null) : null) : null, icon ? _react.default.createElement("div", {
    className: cx('icon')
  }, icon) : null, _react.default.createElement("div", {
    role: "link",
    className: cx('text')
  }, text), _react.default.createElement(_PopupCount.default, {
