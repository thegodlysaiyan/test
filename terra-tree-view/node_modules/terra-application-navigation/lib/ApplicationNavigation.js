...
var ApplicationNavigation = function ApplicationNavigation(_ref) {
  ...
  var utilityButtonPopupAnchorRef = (0, _react.useRef)(); // Need to capture the animation life-cycle as opposed to the open/close state.

  var drawerMenuIsVisibleRef = (0, _react.useRef)(false); // FocusTrap captures the initial value of the onDeactivate callback, so need a persistent ref to the isOpen value.
  ...
  var _useState3 = (0, _react.useState)(false),
      ...
      setPopupMenuIsOpen = _useState4[1]; // Use dot notation temporarily until hooks + enzyme support for userContext
  ...
  function renderDrawerMenu() {
    ...
    }, _react.default.createElement(_DrawerMenu.default, {
  ...
  function renderPopupMenu() {
    ...
    }, _react.default.createElement(_UtilityMenu.default, {
      hero: hero,
      userConfig: userConfig,
      onSelectSettings: onSelectSettings ? generateMenuClosingCallback(onSelectSettings) : undefined,
      onSelectHelp: onSelectHelp ? generateMenuClosingCallback(onSelectHelp) : undefined,
  ...
  function renderCompactHeader() {
    return _react.default.createElement(_CompactHeader.default, {
      ...
      onSelectMenuButton: function onSelectMenuButton() {
        return updateDrawerIsOpen(true);
      },
  ...
  if (navigationItems && activeNavigationItemKey) {
    hiddenMainTitle = _react.default.createElement(_terraVisuallyHiddenText.default, {
      id: "main-inner-title",
      "aria-hidden": true,
  ...
  return _react.default.createElement("div", {
    className: cx('application-navigation')
  ...
  }, renderDrawerMenu()), _react.default.createElement("div", {
    ref: contentLayoutRef,
    className: cx('content-layout', {
      'drawer-menu-is-open': drawerMenuIsOpen
    })
  }, (0, _helpers.shouldRenderCompactNavigation)(activeBreakpoint) ? renderCompactHeader() : renderHeader(), _react.default.createElement("main", {
    ref: mainContainerRef,
    tabIndex: "-1",
    role: "main",
    className: cx('main-container'),
    "aria-labelledby": hiddenMainTitle ? 'main-inner-title' : null
  }, hiddenMainTitle, children), _react.default.createElement(_terraOverlay.default, {
