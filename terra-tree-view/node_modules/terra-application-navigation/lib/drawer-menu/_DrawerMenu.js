...
var DrawerMenu = function DrawerMenu(_ref) {
  var titleConfig = _ref.titleConfig,
      ...
      intl = _ref.intl;
  var titleComponent = titleConfig && !(titleConfig.element || titleConfig.hideTitleWithinDrawerMenu) ? _react.default.createElement(_DrawerMenuTitle.default, {
    titleConfig: titleConfig
  }) : undefined;
  var userComponent = userConfig ? _react.default.createElement(_DrawerMenuUser.default, {
    userConfig: userConfig,
    variant: hero ? 'small' : 'large'
  }) : undefined;
  var logoutButton = onSelectLogout ? _react.default.createElement("div", {
    className: cx('footer')
  }, _react.default.createElement(_DrawerMenuFooterButton.default, {
  ...
  var hasUtils = utilityItems.length || onSelectSettings || onSelectSettings;
  var hasItems = hasNavItems || hasUtils;
  var navItems;

  if (hasNavItems) {
    navItems = _react.default.createElement("div", {
      role: "navigation"
      ...
      return _react.default.createElement(_DrawerMenuLinkItem.default, {
        key: item.key,
        text: item.text,
  ...
  if (hasUtils) {
    utilities = _react.default.createElement("ul", {
      ...
      return _react.default.createElement(_DrawerMenuListItem.default, {
        key: item.key,
        text: item.text,
        icon: item.icon,
        onSelect: onSelectUtilityItem && onSelectUtilityItem.bind(null, item.key, item.metaData)
      });
    }), onSelectSettings ? _react.default.createElement(_DrawerMenuListItem.default, {
      text: intl.formatMessage({
    ...
    }) : null, onSelectHelp ? _react.default.createElement(_DrawerMenuListItem.default, {
      text: intl.formatMessage({
