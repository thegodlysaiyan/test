...
var DrawerMenuTitle = function DrawerMenuTitle(_ref) {
  ...
  return titleConfig.element ? _react.default.createElement("div", {
    title: titleConfig.title,
    className: cx('title-container')
  }, titleConfig.element) : _react.default.createElement("div", {
    className: cx('title-container')
  }, titleConfig.headline ? _react.default.createElement("div", {
    className: cx('headline'),
    title: titleConfig.headline
  }, titleConfig.headline) : null, _react.default.createElement("div", {
    className: cx('title'),
    title: titleConfig.title
