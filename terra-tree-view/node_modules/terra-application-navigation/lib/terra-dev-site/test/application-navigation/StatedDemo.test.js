...
var extensionItems = [{
  ...
  icon: _react.default.createElement(_IconManufacturer.default, null),
  key: 'manufacturer',
  ...
  icon: _react.default.createElement(_IconScratchPad.default, null),
  key: 'inbox',
  text: 'View Inbox',
  metaData: {
    test: 'inbox'
...
var utilityItems = [{
  icon: _react.default.createElement(_IconSave.default, null),
  key: 'save',
  text: 'Save',
  metaData: {
    test: 'save'
  ...
  icon: _react.default.createElement(_IconBookmark.default, null),
  key: 'bookmark',
  text: 'Bookmark',
  metaData: {
    test: 'bookmark'
  ...
  icon: _react.default.createElement(_IconAttachment.default, null),
  key: 'attachment',
  text: 'Add Attachment',
  metaData: {
    test: 'attachment'
...
var StatedDemo = function StatedDemo() {
  ...
  }, _react.default.createElement(_PageContent.default, {
    title: activeKey,
