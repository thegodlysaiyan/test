...
var Facility = /*#__PURE__*/function (_React$Component) {
  ...
  function Facility(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Facility).call(this, props));
    _this.state = {
      fallback: false
    };
  ...
  _createClass(Facility, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          customProps = _objectWithoutProperties(_this$props, ["alt", "color", "hashValue", "image", "isAriaHidden", "size"]);

      var facilityContent;

      if (image) {
        facilityContent = (0, _AvatarUtils.generateImage)(image, alt, isAriaHidden, _AvatarUtils.AVATAR_VARIANTS.FACILITY, this.handleFallback);
      } else {
        facilityContent = (0, _AvatarUtils.generateImagePlaceholder)(alt, isAriaHidden, _AvatarUtils.AVATAR_VARIANTS.FACILITY);
      }
      ...
      var facilityClassNames = cx(['avatar', (0, _AvatarUtils.setColor)(alt, color, hashValue), {
