...
exports.setColor = exports.validateColor = exports.generateImage = exports.generateImagePlaceholder = exports.getColorVariant = exports.calculateHash = exports.COLOR_VARIANTS = exports.AVATAR_VARIANTS = void 0;
...
var generateImagePlaceholder = function generateImagePlaceholder(alt, isAriaHidden, variant) {
...
var generateImage = function generateImage(image, alt, isAriaHidden, variant, handleFallback) {
  var icon = generateImagePlaceholder(alt, isAriaHidden, variant);
  return _react.default.createElement(_terraImage.default, {
    className: cx('image'),
    src: image,
    placeholder: icon,
    alt: alt,
