...
var SelectableMenu = /*#__PURE__*/function (_React$Component) {
  ...
  function SelectableMenu(props) {
    ...
    _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(SelectableMenu).call(this, props));
  ...
  (0, _createClass2.default)(SelectableMenu, [{
    ...
    value: function render() {
      return _react.default.createElement("div", null, _react.default.createElement("div", null, "This menu contains one selectable child (an Item Group). The menu should allow space for the checkmark and the items in the item group should be selectable."), _react.default.createElement(_Menu.default, {
        isOpen: this.state.open,
        targetRef: this.getButtonNode,
        onRequestClose: this.handleRequestClose
      }, _react.default.createElement(_Menu.default.ItemGroup, {
        className: "TestGroup",
