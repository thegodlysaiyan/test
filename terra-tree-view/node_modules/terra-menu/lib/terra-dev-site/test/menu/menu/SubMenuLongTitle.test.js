...
var SubMenuLongTitle = /*#__PURE__*/function (_React$Component) {
  ...
  function SubMenuLongTitle(props) {
    ...
    _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(SubMenuLongTitle).call(this, props));
  ...
  (0, _createClass2.default)(SubMenuLongTitle, [{
    ...
    value: function render() {
      return _react.default.createElement("div", null, _react.default.createElement("div", null, "This menu has a nested submenu with long Default and sub-menu title. When the Nested Menu item is clicked as submenu should replace the initial menu. There should be a header with a back button and a title of Nested Menu."), _react.default.createElement(_Menu.default, {
        ...
        subMenuItems: [_react.default.createElement(_Menu.default.Item, {
          text: "Default 2.1",
          key: "2.1",
