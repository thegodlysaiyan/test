...
var Input = function Input(_ref) {
  ...
  return _react.default.createElement("div", {
  ...
  }, inputValue && inputValue.length ? _react.default.createElement(_terraNavigationPrompt.default, {
    description: title,
    ...
    className: cx('title')
  }, title), inputValue && inputValue.length ? _react.default.createElement("span", {
    className: cx('prompt-text-wrapper')
  }, "(Unsaved value is present and NavigationPrompt is rendered)") : null), _react.default.createElement("input", {
    type: "text",
...
var Form = function Form(_ref2) {
  ...
  return _react.default.createElement("div", {
  ...
  }, _react.default.createElement(_terraNavigationPrompt.NavigationPromptCheckpoint, {
    ref: inputCheckpointRef
  }, _react.default.createElement(_react.default.Fragment, {
    key: timeStamp
  }, _react.default.createElement("h3", null, title), _react.default.createElement("p", null, "The Form renders a NavigationPromptCheckpoint around its child Input components. If NavigationPrompts are rendered by any child components, the Form will resolve those prompts before resetting the Input values."), _react.default.createElement("p", null, "Last Updated:", ' ', new Date(timeStamp).toLocaleString()), _react.default.createElement(Input, {
    title: "Text Input A",
    ...
    onClick: function onClick() {
      ...
      }).catch(function () {// User prevented navigation.
      });
    }
...
var FormSwitcher = function FormSwitcher() {
  ...
  function onSwitchForm(formKey) {
    ...
    }).catch(function () {// User prevented form switch.
    });
  }

  return _react.default.createElement("div", null, _react.default.createElement("h2", null, "Form Switcher"), _react.default.createElement("p", null, "The FormSwitcher is an example component that uses the NavigationPrompt and NavigationPromptCheckpoint. If NavigationPrompts are rendered by any child components, the FormSwitcher will resolve those prompts before rendering a different Form."), _react.default.createElement("button", {
    type: "button",
  ...
  }, "Switch to Form 2"), _react.default.createElement("br", null), _react.default.createElement("br", null), _react.default.createElement(_terraNavigationPrompt.NavigationPromptCheckpoint, {
...
var NavigationPromptExample = function NavigationPromptExample() {
  ...
  return _react.default.createElement("div", {
    ...
    className: cx('title')
  }, "Registered Prompts: "), prompts.length ? _react.default.createElement("span", null, prompts.map(function (prompt) {
    return "".concat(prompt.description, " (").concat(prompt.metaData.value, ")");
  }).join(', ')) : null, _react.default.createElement("br", null), _react.default.createElement("hr", null), _react.default.createElement(_terraNavigationPrompt.NavigationPromptCheckpoint, {
    onPromptChange: function onPromptChange(newPrompts) {
      setPrompts(newPrompts);
    }
  }, _react.default.createElement(FormSwitcher, null)));
};
