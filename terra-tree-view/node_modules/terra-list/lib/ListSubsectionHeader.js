...
var ListSubsectionHeader = function ListSubsectionHeader(_ref) {
  var isCollapsed = _ref.isCollapsed,
      ...
      title = _ref.title,
      customProps = _objectWithoutProperties(_ref, ["isCollapsed", "isCollapsible", "level", "metaData", "onBlur", "onClick", "onKeyDown", "onMouseDown", "onSelect", "refCallback", "title"]);

  var sectionHeaderClassNames = cx(['subsection-header', {
    'is-collapsible': isCollapsible
  }, customProps.className]);
  var attrSpread = {};
  var Element = "h".concat(level);

  var titleElement = _react.default.createElement(Element, {
    className: cx('title')
  }, title);
  ...
  if (isCollapsible) {
    accordionIcon = _react.default.createElement("div", {
      className: cx('start')
