...
var ListItem = function ListItem(_ref) {
  var children = _ref.children,
      ...
      customProps = _objectWithoutProperties(_ref, ["children", "hasChevron", "isSelected", "isSelectable", "metaData", "onBlur", "onClick", "onKeyDown", "onMouseDown", "onSelect", "refCallback"]);

  var listItemClassNames = cx(['list-item', {
  ...
  return _react.default.createElement("li", _extends({}, customProps, attrSpread, {
    className: listItemClassNames,
    ref: refCallback
  }), _react.default.createElement("div", {
    className: cx('item-fill'),
    key: "item-fill"
  }, children), hasChevron && _react.default.createElement("div", {
    className: cx('item-end'),
    key: "item-end"
  }, _react.default.createElement("span", {
    className: cx('chevron')
  }, _react.default.createElement(_IconChevronRight.default, {
    height: "1em",
    width: "1em"
  }))));
};
