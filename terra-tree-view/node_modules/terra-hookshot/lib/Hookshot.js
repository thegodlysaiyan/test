...
function (_React$Component) {
  ...
  function Hookshot(props) {
    ...
    _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(Hookshot).call(this, props));
  ...
  (0, _createClass2.default)(Hookshot, [{
    ...
    value: function tick(event) {
      if (this.lastDuration && this.lastDuration > 16) {
        ...
        this.lastDuration = Math.min(this.lastDuration - 16, 100); // Just in case this is the last event, remember to position just once more
    ...
    value: function cloneContent(content) {
      return _react.default.cloneElement(content, {
