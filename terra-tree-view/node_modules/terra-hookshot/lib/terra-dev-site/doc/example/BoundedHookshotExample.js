...
var getId = function getId(name) {
  return "".concat(name, "BoundedExample");
};
  ...
  (0, _createClass2.default)(HookshotStandard, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", null, _react.default.createElement("div", {
        ...
        className: cx('label')
      }, "Target Attachment")), _react.default.createElement("select", {
        ...
        className: cx('select-wrapper')
      }, generateOptions(ATTACHMENT_POSITIONS)), _react.default.createElement("br", null), _react.default.createElement("br", null), _react.default.createElement(_terraHookshot.default, {
        ...
        targetRef: function targetRef() {
          return document.getElementById('hookshot-bounded-button');
        }
      }, hookshotContent), _react.default.createElement("div", {
