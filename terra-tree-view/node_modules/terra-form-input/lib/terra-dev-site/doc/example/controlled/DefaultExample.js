...
var DefaultExample = /*#__PURE__*/function (_React$Component) {
  ...
  function DefaultExample(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(DefaultExample).call(this, props));
    _this.state = {
      input: 'Default Input'
    };
