...
var DisabledExample = /*#__PURE__*/function (_React$Component) {
  ...
  function DisabledExample(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(DisabledExample).call(this, props));
    _this.state = {
      input: 'Disabled Example input'
    };
