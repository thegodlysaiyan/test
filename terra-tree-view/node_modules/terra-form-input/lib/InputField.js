...
var InputField = function InputField(props) {
  var defaultValue = props.defaultValue,
      ...
      type = props.type,
      value = props.value,
      customProps = _objectWithoutProperties(props, ["defaultValue", "disabled", "error", "errorIcon", "help", "hideRequired", "inputAttrs", "inputId", "isIncomplete", "isInline", "isInvalid", "isLabelHidden", "label", "labelAttrs", "maxWidth", "onChange", "placeholder", "refCallback", "required", "showOptional", "type", "value"]);
  ...
  return _react.default.createElement(_terraFormField.default, _extends({
    label: label,
    ...
    htmlFor: inputId,
    maxWidth: maxWidth
  }, customProps), _react.default.createElement(_Input.default, _extends({}, inputAttrs, {
