...
var ModalNoFocusableContent = /*#__PURE__*/function (_React$Component) {
  ...
  function ModalNoFocusableContent() {
    ...
    _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(ModalNoFocusableContent).call(this));
    _this.state = {
      isOpen: true
    };
  ...
  (0, _createClass2.default)(ModalNoFocusableContent, [{
    ...
    value: function render() {
      ...
      }, _react.default.createElement("div", null, "No focusable content inside the modal.")), _react.default.createElement("button", {
        type: "button",
