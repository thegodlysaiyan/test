...
var Spacer = function Spacer(_ref) {
  ...
  var SpacerClassNames = cx(["margin-top-".concat(_spacerConstants.SpacerClassMappings[marginAttributes.marginTop]), "margin-bottom-".concat(_spacerConstants.SpacerClassMappings[marginAttributes.marginBottom]), "margin-left-".concat(_spacerConstants.SpacerClassMappings[marginAttributes.marginLeft]), "margin-right-".concat(_spacerConstants.SpacerClassMappings[marginAttributes.marginRight]), "padding-top-".concat(_spacerConstants.SpacerClassMappings[paddingAttributes.paddingTop]), "padding-bottom-".concat(_spacerConstants.SpacerClassMappings[paddingAttributes.paddingBottom]), "padding-left-".concat(_spacerConstants.SpacerClassMappings[paddingAttributes.paddingLeft]), "padding-right-".concat(_spacerConstants.SpacerClassMappings[paddingAttributes.paddingRight]), {
