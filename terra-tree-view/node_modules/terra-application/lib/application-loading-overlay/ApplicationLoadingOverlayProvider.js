...
var ApplicationLoadingOverlayProvider = function ApplicationLoadingOverlayProvider(_ref) {
  var children = _ref.children,
      ...
      customProps = (0, _objectWithoutProperties2.default)(_ref, ["children", "scrollRefCallback"]);
    ...
    return {
      show: function show(key, data) {
        setRegisteredLoadingOverlays(function (state) {
          return _objectSpread({}, state, (0, _defineProperty2.default)({}, "".concat(key), data));
        });
      },
  ...
  var overlay = _react.default.createElement(_LoadingOverlay.default, {
  ...
  return _react.default.createElement(_OverlayContainer.default, (0, _extends2.default)({}, customProps, {
    className: className,
    overlay: overlay
  }), _react.default.createElement(_terraScroll.default, {
    refCallback: scrollRefCallback
  }, _react.default.createElement(_ApplicationLoadingOverlayContext.default.Provider, {
    value: contextValue
  }, children)));
};
