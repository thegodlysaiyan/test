...
var ButtonGroupButton = /*#__PURE__*/function (_React$Component) {
  ...
  function ButtonGroupButton(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(ButtonGroupButton).call(this, props));
    _this.state = {
      focused: false
    };
  ...
  _createClass(ButtonGroupButton, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          customProps = _objectWithoutProperties(_this$props, ["icon", "isDisabled"]);

      var buttonClassName = cx(['button-group-button', {
        'is-disabled': isDisabled
      }, {
        'is-focused': this.state.focused
      }, customProps.className]);
      return _react.default.createElement(_terraButton.default, _extends({}, customProps, {
        icon: icon,
