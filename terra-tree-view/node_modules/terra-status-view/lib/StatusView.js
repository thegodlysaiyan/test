...
exports.StatusViewVariants = exports.default = void 0;
...
var generateButtons = function generateButtons(buttonAttrsArray) {
  ...
  return buttonAttrsArray.map(function (button) {
    return _react.default.createElement(_terraButton.default, _extends({}, button, {
...
var StatusView = function StatusView(_ref) {
  var buttonAttrs = _ref.buttonAttrs,
      ...
      customProps = _objectWithoutProperties(_ref, ["buttonAttrs", "customGlyph", "isAlignedTop", "isGlyphHidden", "message", "title", "variant"]);

  var glyphSection;

  if (customGlyph && !isGlyphHidden) {
    glyphSection = _react.default.createElement("div", {
      className: cx('glyph')
    }, customGlyph);
  ...
  if (variant) {
    defaultTitle = _react.default.createElement(_reactIntl.FormattedMessage, {
  ...
  if (title || defaultTitle) {
    titleSection = _react.default.createElement("p", {
      className: cx('title')
    }, title || defaultTitle);
  }
  ...
  if (message) {
    messageSection = _react.default.createElement("p", {
  ...
  if (buttons) {
    actionSection = _react.default.createElement("div", {
  ...
  if (titleSection && (messageSection || actionSection)) {
    dividerSection = _react.default.createElement("div", {
      className: cx('divider')
    }, _react.default.createElement(_terraDivider.default, null));
  }

  var outerViewClassNames = cx(['outer-view', {
  ...
  }, glyphSection, titleSection, dividerSection, messageSection, actionSection), _react.default.createElement("div", {
